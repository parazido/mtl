...
namespace devices {
    namespace descriptor {
        template <uint32_t v_base_address> struct timer_1 {
            ...
            struct smcr : register_<0x08, uint32_t> {
                ...
                struct occs : mtl::hw::field<smcr, 3, 1> {
                    using option = mtl::hw::option<occs>;
                    constexpr static option ocref_clr = 0;
                    constexpr static option etrf = 1;
                };
            ...
            struct dmar : register_<0x4c, uint16_t> {};
        };

        template <uint32_t v_base_address> struct timer_2_3 {
            constexpr static uint32_t base_address = v_base_address;
            template <uint32_t v_offset, class t_type>
            using register_ = mtl::hw::register_<base_address, v_offset, t_type>;
            ...
            struct ccer : register_<0x20, uint32_t> {
                ...
                struct cc4np : mtl::hw::field<ccer, 14, 1> {
                    using option = mtl::hw::option<cc4np>;
                    constexpr static option zero = 0;
                    constexpr static option one = 1;
                };
        ...
        template <uint32_t v_base_address> struct timer_14 {
            constexpr static uint32_t base_address = v_base_address;
            template <uint32_t v_offset, class t_type>
            using register_ = mtl::hw::register_<base_address, v_offset, t_type>;
        ...
        template <uint32_t v_base_address> struct timer_15 {
            constexpr static uint32_t base_address = v_base_address;
            template <uint32_t v_offset, class t_type>
            using register_ = mtl::hw::register_<base_address, v_offset, t_type>;
        ...
        template <uint32_t v_base_address> struct timer_16_17 {
            constexpr static uint32_t base_address = v_base_address;
            template <uint32_t v_offset, class t_type>
            using register_ = mtl::hw::register_<base_address, v_offset, t_type>;
    ...
    using timer1 = descriptor::timer_1<0x40012C00>;
    using timer2 = descriptor::timer_2_3<0x40000000>;
    using timer3 = descriptor::timer_2_3<0x40000400>;
    using timer6 = descriptor::timer_6_7<0x40001000>;
    using timer7 = descriptor::timer_6_7<0x40001400>;
    using timer14 = descriptor::timer_14<0x40002000>;
