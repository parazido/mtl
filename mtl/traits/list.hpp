...
namespace mtl::traits {
    namespace detail {
      template<class t_entry, class... t_entries>
      struct entry_in_list {
    ...
    struct list<t_last> {
      ...
      template<class t_entry>
      constexpr static bool contains = detail::entry_in_list<t_entry, t_last>::value;
    ...
    template<class t_type, class... t_list_types>
    struct is_in<list<t_list_types...>, t_type> {
